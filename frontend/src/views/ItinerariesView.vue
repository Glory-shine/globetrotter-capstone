...
<template>
  <div class="relative min-h-screen overflow-hidden bg-gradient-to-br from-cream via-lavender-light to-cream">
    ...
    <div class="relative mx-auto max-w-7xl px-6 py-12 sm:px-8">
      <div class="max-w-2xl">
        <p class="font-mono text-xs uppercase tracking-[0.4em] text-sage">Planificateur</p>
        <h1 class="mt-3 font-display text-6xl font-light text-deep-blue sm:text-7xl">Vos itinéraires</h1>
        <p class="mt-4 text-lg text-text-secondary leading-relaxed">
          Organisez vos journées à Bafoussam, ajustez votre parcours, et gardez-le pour plus tard.
        </p>
      </div>
